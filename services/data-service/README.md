...
### 주요 기능
- 🔍 **다중 소스 크롤링**: 5개 주요 언론사 뉴스 실시간 수집 (1,000건/시간)
...
### 지원 뉴스 소스 (고성능 스케줄링)
| 언론사 | Source ID | 수집 간격 | 우선순위 | 특징 |
|--------|-----------|------------|----------|------|
| 연합뉴스 | `yonhap` | 1분 | URGENT | 속보 대응 |
| 조선일보 | `chosun` | 3분 | HIGH | 주요 종합 일간지 |
| 한국경제 | `hankyung` | 3분 | HIGH | 경제 전문지 |
| 중앙일보 | `joongang` | 5분 | NORMAL | 주요 종합 일간지 |
| 매일경제 | `mk` | 5분 | NORMAL | 경제 전문지 |
